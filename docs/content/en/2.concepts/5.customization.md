...
- **`docs` layout:** Standard documentation layout with header, left/right asides and footer. Defined in `layer/app/layouts/docs.vue`.
- **`landing` layout:** Minimal layout without header and footer, useful for home/marketing pages. Defined in `layer/app/layouts/landing.vue`.
