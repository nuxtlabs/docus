...
Une fois votre contenu déplacé dans le dossier `content/`, vous pouvez consulter la [section configuration](/concepts/configuration) pour personnaliser facilement votre application.
